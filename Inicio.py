...
with col1:
    st.image("assets/programerKev.jpg", width=200, caption="Estudiante", output_format="JPEG")

# Columna derecha: Información del estudiante
with col2:
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">Kevin Alfonso Olivella Felizzola</h3>', unsafe_allow_html=True)
    ...
    st.markdown('<p>Repositorio: <a href="https://github.com/Kevolive/proyecto-integrador.git" target="_blank" style="color: #0066cc; font-weight: bold; text-decoration: none;">GitHub</a></p>', unsafe_allow_html=True)
